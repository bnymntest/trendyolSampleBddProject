...
public class MyStepdefs extends Dictionary {
    ...
    public void saveVaraible(String value, String key) {
        setData(key, removeQuotes(value));
    ...
    public void type(String text) {
        actions.sendKeys(removeQuotes(text)).perform();
    }
    ...
    public void seeElement(String elementKey, int seconds){
    ...
    public void doNotSeeElement(String elementKey, int seconds){
